...
namespace testi2
{
    public partial class MainViewFullScreen : Form
    {
        ...
        public MainViewFullScreen()
        {
            ...
            {
                this.BackColor = System.Drawing.ColorTranslator.FromHtml(colors[9]);
            }
            else
            {
                this.BackColor = System.Drawing.ColorTranslator.FromHtml(colors[0]);
            }
        ...
        {
            string query = "SELECT avg(temperature) FROM weather WHERE DATE(time) = '" + DateTime.Today.ToString("yyyy.MM.dd") + "' AND HOUR(time) = '" + (DateTime.Now.Hour - 1).ToString() + "';";
        ...
        private void SetupBackColor()
        {
            ...
            this.BackColor = System.Drawing.ColorTranslator.FromHtml(colors[i]);
        }
